    ...
    <div className="min-h-screen bg-[#0a1628] px-6 py-8 pb-32">
      ...
      >
        <div className="p-4 rounded-2xl" style={cardStyle}>
          ...
          <p className="text-white/40 text-xs">Total Abonați</p>
        ...
        <div className="p-4 rounded-2xl" style={cardStyle}>
          ...
          <p className="text-white/40 text-xs">Utilizatori Logați</p>
        ...
        <div className="p-4 rounded-2xl" style={cardStyle}>
          ...
          <p className="text-white/40 text-xs">Emailuri Trimise</p>
          <p className="text-white/40 text-xs mt-1">azi</p>
        </div>
        ...
        <div className="p-4 rounded-2xl" style={cardStyle}>
          ...
          <p className="text-white/40 text-xs">Notificări Necitite</p>
        </div>
      </motion.section>
        ...
        <div className="space-y-2">
          {notifications && notifications.length > 0 ? (
              ...
              <div key={notif.id} className="p-3 rounded-xl" style={cardStyle}>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white/40 text-xs truncate">{notif.message}</p>
            ...
            <div className="p-4 rounded-xl text-center" style={cardStyle}>
              <p className="text-white/40 text-sm">Nicio notificare nouă</p>
            </div>
          )}
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="space-y-2">
          {subscribersLoading ? (
            ...
            <div className="p-4 rounded-xl text-center" style={cardStyle}>
              <p className="text-white/40 text-sm">Niciun abonat încă</p>
            </div>
          )}
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="space-y-2">
          {emailLogs && emailLogs.length > 0 ? (
              ...
              <div key={log.id} className="p-3 rounded-xl" style={cardStyle}>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-white/40 text-xs">{log.recipientEmail}</p>
                  </div>
            ...
            <div className="p-4 rounded-xl text-center" style={cardStyle}>
              <p className="text-white/40 text-sm">Niciun email trimis încă</p>
            </div>
          )}
        </div>
      </motion.section>
